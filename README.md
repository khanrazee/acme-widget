...
- **Products**: Product catalog with name, description, price, and inventory
- **Users**: Authentication using Devise with role-based access (admin/customer)
- **Carts**: Shopping cart before checkout
- **CartItems**: Items in a cart with product, quantity, and price
- **Orders**: Completed purchases after checkout
- **LineItems**: Items in an order with product, quantity, and price
...
2. **Customer Users**:
   ...
   - Register a new account or use the application as a guest
